...
class plc3(PLC):
	...
	def fetchData(self):
		print("PLC3 data transmission starting at", time.time())
...
# 		self.hmimv301status_upd, self.hmimv301avl = self.MV301_FB.MV_FBD(self.Mid_MV301_AutoInp, self.IO.MV301, self.hmimv301auto)
...
# 		self.hmimv302status_upd, self.hmimv302avl = self.MV302_FB.MV_FBD(self.Mid_MV302_AutoInp, self.IO.MV302, self.hmimv302auto)
...
# 		self.hmimv303status_upd, self.hmimv303avl = self.MV303_FB.MV_FBD(self.Mid_MV303_AutoInp, self.IO.MV303, self.hmimv303auto)
...
# 		self.hmimv304status_upd, self.hmimv304avl = self.MV304_FB.MV_FBD(self.Mid_MV304_AutoInp, self.IO.MV304, self.hmimv304auto)
...
# 		setdata(self, 'HMI.LIT301.AL',SCADA_ADDR,self.hmilit301al)
		...
		print("PLC3 data transmission ending at", time.time())

		####### setdata() calls end here ###############

		elapsed = time.time() - iter_start
		print('PLC3 Iteration time:', elapsed)
