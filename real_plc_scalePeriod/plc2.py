...
# 		self.AIT203_FB = AIN_FBD(self.hmiait203hty,self.hmiait203ahh,self.hmiait203ah,self.hmiait203al,self.hmiait203all)
	...
	def fetchData(self):
		...
		print("PLC2 data transmission starting at", time.time())
	...
	def Iteration(self):
		...
		#
		# self.hmimv201status_upd, self.hmimv201avl = self.MV201_FB.MV_FBD(self.Mid_MV201_AutoInp, self.IO.MV201, self.hmimv201auto)
		...
		# print("PLC2 data transmission ending at", time.time())

		######### setadata() calls end here ##################

		elapsed = time.time() - iter_start
		print('PLC2 Iteration time:', elapsed)
